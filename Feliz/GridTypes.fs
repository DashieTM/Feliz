...
type gridTrackRepeat =
    ...
    static member inline repeat
        ...
        : IGridTrackRepeat = unbox ("repeat(" + string<int> count + ", " + GridUtils.unboxSeq lineNamesAndSizes + ")")
    ...
    /// https://developer.mozilla.org/en-US/docs/Web/CSS/repeat
    static member inline repeat
        (count: int,  additionalLines: IGridLineNames, [<ParamArray>]lineNamesAndSizes: IGridTrackNameWithTrackSize array)
        : IGridTrackRepeat =
        unbox (
            "repeat("
            + string<int> count
...
type gridFixedRepeat =
    ...
    static member inline repeat
        ...
        : IGridFixedRepeat =
        unbox ("repeat(" + string<int> count + ", " + GridUtils.unboxSeq lineNamesAndSizes + ")")
    ...
    /// https://developer.mozilla.org/en-US/docs/Web/CSS/repeat
    static member inline repeat
        (count: int, additionalLines: IGridLineNames,  [<ParamArray>]lineNamesAndSizes: IGridTrackNameWithFixedSize array)
        : IGridFixedRepeat =
        unbox (
            "repeat("
            + string<int> count
...
type gridAutoRepeat =
    ...
    static member inline repeatAutoFill
        ...
        : IGridAutoRepeat = unbox ("repeat(auto-fill, " + GridUtils.unboxSeq lineNamesAndSizes + " " + unbox additionalLines + ")")
    ...
    static member inline repeatAutoFit
        (additionalLines: IGridLineNames, [<ParamArray>]lineNamesAndSizes: IGridTrackNameWithFixedSize array)
        : IGridAutoRepeat = unbox ("repeat(auto-fit, " + GridUtils.unboxSeq lineNamesAndSizes + " " + unbox additionalLines + ")")
...
type explicitTrackList =
    ...
    static member inline list([<ParamArray>] linesWithSizes: IGridTrackNameWithFixedSize array) : IGridExplicitTrackList =
